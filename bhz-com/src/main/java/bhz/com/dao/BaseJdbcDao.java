...
public class BaseJdbcDao {
    ...
    public Long getCurrentTime() {
        return this.getJdbcTemplate().queryForObject("SELECT UNIX_TIMESTAMP() FROM DUAL", Long.class);
    }
    ...
    public String generateKey() {
        String sql = "select DATE_FORMAT(NOW(),'%Y-%m-%d_') FROM DUAL";
